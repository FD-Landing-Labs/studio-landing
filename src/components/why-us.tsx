...
import { Plus, Star, Zap, Scissors, Clock } from "lucide-react"
    ...
    <section id="why-us" className="py-20 md:py-28 lg:py-32 bg-white">
      <div className="px-6 lg:px-10">
        ...
        <motion.h2
          ...
          className="text-[clamp(2rem,5vw,3.5rem)] font-medium tracking-tight leading-[1.15] mb-12 md:mb-16 max-w-4xl"
        >
          {whyUs.headline.main}{" "}
          <span className="text-muted-foreground">{whyUs.headline.highlight}</span>
        </motion.h2>
        ...
        >
          ...
          <motion.div variants={cardVariants} className="lg:row-span-2 flex flex-col">
            {/* Top part with image */}
            <div className="relative bg-[#1a1a1a] rounded-2xl p-6 flex-1 flex flex-col min-h-[300px] overflow-hidden">
              <h3 className="text-white text-lg md:text-xl font-medium leading-tight mb-4 relative z-10">
              ...
              <div className="relative flex-1 -mx-6 -mb-6 mt-auto">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 flex items-end justify-between">
                  ...
                  <Link
                    ...
                    className="flex items-center gap-2 px-4 py-2 bg-white/90 hover:bg-white rounded-full text-sm font-medium text-foreground transition-colors"
                  >
          ...
          <motion.div variants={cardVariants} className="lg:row-span-2 flex flex-col gap-4">
            ...
            {/* Bottom - Testimonial */}
            <div className="bg-muted/50 rounded-2xl p-5 flex-1 flex flex-col">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-medium">{whyUs.socialProof.testimonial.author}</p>
                  <p className="text-xs text-muted-foreground">{whyUs.socialProof.testimonial.role}</p>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          <motion.div variants={cardVariants} className="lg:row-span-2 flex flex-col gap-4">
            {whyUs.features.map((feature) => {
              ...
              return (
                <div
                  key={feature.id}
                  className="bg-muted/50 rounded-2xl p-5 flex-1 hover:bg-muted/70 transition-colors"
                >
